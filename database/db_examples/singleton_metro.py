...
class MetroSystem:
    ...
    def __new__(cls, *args, **kwargs):
        if not cls._instance:
            cls._instance = super(MetroSystem, cls).__new__(cls)
...
if __name__ == "__main__":
    metro1 = MetroSystem()  # First instance
    metro2 = MetroSystem()  # Second instance

    print(metro1 is metro2)  # Should print True, proving Singleton behavior

    # Test functionalities
    metro1.register_user("Alice", "CARD123")
    metro1.add_credit("CARD123", 50)
    metro1.enter_metro("CARD123", 2.5)
    metro1.check_balance("CARD123")
    metro1.generate_report("users")
    metro1.generate_report("transactions")
