...
class DNSChangerApp(QWidget):
    ...
    def change_dns(self):
        ...
        command1 = f"netsh interface ip set dns name=\"Wi-Fi\" static {primary_dns} primary"
        command2 = f"netsh interface ip add dns name=\"Wi-Fi\" addr={secondary_dns} index=2"
    ...
    def deactivate_dns(self):
        ...
        command = f"netsh interface ip set dns name=\"Wi-Fi\" dhcp"
