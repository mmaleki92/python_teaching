...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pass_lineEdit = QLineEdit(self.centralwidget)
        self.pass_lineEdit.setObjectName(u"pass_lineEdit")

        self.gridLayout.addWidget(self.pass_lineEdit, 4, 0, 1, 1)

        self.user_lineEdit = QLineEdit(self.centralwidget)
        self.user_lineEdit.setObjectName(u"user_lineEdit")

        self.gridLayout.addWidget(self.user_lineEdit, 2, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn.setText(QCoreApplication.translate("MainWindow", u"submit", None))
